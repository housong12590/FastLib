package com.ws.fastlib.network.log;

import android.text.TextUtils;


import com.ws.fastlib.utils.StringUtils;
...
/**
 * @author ihsan onSuccess 09/02/2017.
 */
...
class Printer {
    ...
    static void printJsonRequest(LoggingInterceptor.Builder builder, Request request) {
        ...
        logger.log(builder.getType(), tag, REQUEST_UP_LINE);
        ...
        logger.log(builder.getType(), tag, END_LINE);
    }
    ...
    static void printJsonResponse(LoggingInterceptor.Builder builder, long chainMs, boolean isSuccessful,
        ...
        Logger logger = builder.getLogger();
        logger.log(builder.getType(), tag, RESPONSE_UP_LINE);
    ...
    static String getJsonString(String msg) {
        ...
        return StringUtils.convertUnicode(message);
    }
